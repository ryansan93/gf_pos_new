				...
				<div class="col-md-12 text-left no-padding">
					<div class="col-md-8 no-padding">
						...
						<div class="col-md-12 no-padding">
							<div class="col-md-3 no-padding" style="padding-right: 5px;">
								<div class="col-md-12 no-padding"><label class="label-control">Grup</label></div>
								<div class="col-md-12 no-padding"><input type="text" class="form-control grup uppercase" placeholder="grup"></div>
							</div>
							<div class="col-md-3 no-padding" style="padding-right: 5px;">
								<div class="col-md-12 no-padding"><label class="label-control">Nama</label></div>
								<div class="col-md-12 no-padding"><input type="text" class="form-control nama uppercase" placeholder="nama"></div>
							</div>
							<div class="col-md-3 no-padding" style="padding-right: 10px;">
								<div class="col-md-12 no-padding"><label class="label-control">No. Telp</label></div>
								<div class="col-md-12 no-padding"><input type="text" class="form-control no_telp uppercase" placeholder="no. telp"></div>
							</div>
							<div class="col-md-3 no-padding">
								<div class="col-md-12 no-padding"><label class="label-control">&nbsp;</label></div>
								<div class="col-md-12 no-padding"><button type="button" class="btn btn-primary" onclick="mbr.pagination(this)"><i class="fa fa-search"></i></button></div>
							</div>
						</div>
						<!--
						<div class="col-md-12 no-padding">
							<div class="col-md-3 no-padding" style="padding-right: 5px;">
								<div class="col-md-12 no-padding"><label class="label-control">Kode</label></div>
								<div class="col-md-12 no-padding"><input type="text" class="form-control kode uppercase" placeholder="kode"></div>
							</div>
							<div class="col-md-3 no-padding" style="padding-right: 10px;">
								<div class="col-md-12 no-padding"><label class="label-control">Tgl Berakhir</label></div>
								<div class="col-md-12 no-padding"><input type="text" class="form-control tgl_berakhir uppercase" placeholder="tgl berakhir"></div>
							</div>
							<div class="col-md-3 no-padding" style="padding-right: 10px;">
								<div class="col-md-12 no-padding"><label class="label-control">Status</label></div>
								<div class="col-md-12 no-padding"><input type="text" class="form-control status uppercase" placeholder="status"></div>
							</div>
						</div>
						-->
					</div>
					<?php if ( $akses['a_submit'] ): ?>
						<div class="col-md-4 no-padding">
							<button type="button" class="btn btn-primary pull-right" onclick="mbr.addForm(this)"><i class="fa fa-plus"></i> Tambah</button>
						</div>
					<?php endif ?>
				</div>
			</div>
			<small>
				<div class="col-md-12 no-padding" style="padding: 5px; height: 86.5%;">
					...
					<div class="col-md-12 text-center no-padding list_member">
						<div class="col-md-12 text-center no-padding list">
							<?php if ( !empty($data) ): ?>
								<?php $idx = 1; ?>
						...
						<div class="col-md-12 text-center no-padding pagination">
						</div>
					</div>
				</div>
			</small>
